    ...
    async _handshake() {
        await new Promise((resolve, reject) => {
            ...
            const onData = (message) => {
                try {
                    const name = binarytf_1.deserialize(message, 11);
                    if (typeof name === 'string') {
                        ...
                        this.socket.write(Header_1.createFromID(Header_1.readID(message), false, binarytf_1.serialize(this.client.name)));
                        // eslint-disable-next-line @typescript-eslint/no-use-before-define
