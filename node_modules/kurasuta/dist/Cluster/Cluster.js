...
class Cluster extends events_1.EventEmitter {
    ...
    async spawn() {
        ...
        this.worker = cluster_1.fork(Object.assign({ CLUSTER_SHARDS: this.shards.join(','), CLUSTER_ID: this.id.toString(), CLUSTER_SHARD_COUNT: this.manager.shardCount.toString(), CLUSTER_CLUSTER_COUNT: this.manager.clusterCount.toString() }, process.env));
